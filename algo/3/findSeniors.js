...
function findSeniors(persons) {
  const personsWebSeniors = [
    persons.filter(person => person.experience >= 5 && person.job === "web dev"),
    persons.filter(person => person.experience >= 5 && person.job === "data analyst")
  ];
  return personsWebSeniors;
}
